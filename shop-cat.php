...
if (!isset($_SESSION['email'])) {
  header('location:index.php');
    ...
    if(isset($_POST['add_to_cart'])){
      ...
      $add_cart="INSERT INTO cart(email,pname,bprice,quantity,status) VALUES ('$email','$pname','$bprice','$qua','1')";
...
<body>
    <header>
      <nav>
        ...
        <div class="menu">
          <ul>
            ...
            <li><a href="shopping.php" class="active">Shopping</a></li>
      ...
      <h1 class="overlay-text ml-1 text-center animated zoomIn">Our New Defination of shopping</h1>
      <h1 class="overlay-text ml-1 text-center animated zoomIn">will let you explore in a dynamic way</h1>
    </header>
    <!-- Products -->
    <section class="products">
    <div class="content">
      <div class="container-fluid">
        <h1 class="latest text-center text-white bg-info p-1">Shopping Deals</h1>
        <div class="row mt-4" data-aos="fade-up">
          <div class="col-md-2">
            <ul class="list-group">
            <?php 
            $sql1="SELECT DISTINCT pcategory FROM shopping";
            $query1=mysqli_query($conn,$sql1);
            while ($result1=mysqli_fetch_array($query1)) {
              ?>
            <li class="list-group-item"><a href="shop-cat.php?cat=<?php echo $result1['pcategory'] ?>" class="text-decoration-none"><?php echo $result1['pcategory'] ?></a></li>
            <?php
            }
            ?>
            </ul>
          ...
          <?php
          $pcategory=$_GET['cat'];
          $sql2="SELECT * FROM shopping WHERE pcategory='$pcategory'";
