...
<body>
    ...
    <div class="content">
      <div class="container-fluid">
        <h1 class="latest text-center text-white bg-info p-1">Products</h1>
        <div class="row mt-4" data-aos="fade-up">
          <div class="col-md-2">
            ...
            while ($result=mysqli_fetch_array($query)) {
              ?>
            <li class="list-group-item"><a href="shop-cat.php?cat=<?php echo $result['pcategory'] ?>" class="text-decoration-none"><?php echo $result['pcategory'] ?></a></li>
            <?php
            }
            ?>
            </ul>
    ...
    <input type="text" class="form-control" id="searchInput" onkeyup="myFunction()" placeholder="Search Products">
    </div>
          <?php
          $sql2="SELECT * FROM shopping WHERE pcategory='Deals'";
